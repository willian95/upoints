    ...
    <div class="aside aside-left d-flex flex-column" id="kt_aside">
        ...
        <div class="aside-brand d-flex flex-column align-items-center flex-column-auto pt-5 pt-lg-18 pb-10">
            ...
            <div class="btn p-0 symbol symbol-60 symbol-light-primary" href="?page=index" id="kt_quick_user_toggle">
                <div class="symbol-label">
                    <img alt="Logo" :src="$auth.user.image" class="h-75 align-self-end" />
                </div>
        ...
        <div class="aside-nav d-flex flex-column align-items-center flex-column-fluid pb-10">
            ...
            <ul class="nav flex-column">
                ...
                <!--begin::Item-->
                <li class="nav-item mb-2" v-tooltip="'Perfil'">
                    <NuxtLink :to="'/app/profile'" class="nav-link btn btn-icon btn-hover-text-primary btn-lg" data-toggle="tab" data-target="#kt_aside_tab_4" role="tab">
                ...
                <!--begin::Item-->
                <li class="nav-item mb-2" v-tooltip="'Lector QR'" v-if="$auth.user.role_id == 3">
                    <NuxtLink :to="'/app/scanner'" class="nav-link btn btn-icon btn-hover-text-primary btn-lg" data-toggle="tab" data-target="#kt_aside_tab_4" role="tab">
        ...
        <div class="aside-footer d-flex flex-column align-items-center flex-column-auto py-8">
            ...
            <!--begin::Notifications-->
            <button @click="signOut()" class="btn btn-icon btn-hover-text-primary btn-lg mb-1 position-relative" id="kt_quick_notifications_toggle" v-tooltip="'Cerrar sesión'">
                <fa icon="sign-out-alt" class="mr-1"></fa>
            </button>
            <!--end::Notifications-->
